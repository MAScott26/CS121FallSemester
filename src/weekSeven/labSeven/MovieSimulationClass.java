...
public class MovieSimulationClass {
    ...
    private static String[] movieNames = {"Jumanji", "Matrix", "Star Wars", "Oppenheimer"};
    private static String[] movieTypes = {"3D", "2D", "3D", "2D"};
    private static double[] moviePrices = {15.00, 12.00, 14.00, 12.00};

    private static final int ROWS = 5;
    private static final int COLUMNS = 10;

    private static int[][] movieAvailability = new int[ROWS][COLUMNS];
